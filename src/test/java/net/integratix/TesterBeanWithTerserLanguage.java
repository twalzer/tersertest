...
public class TesterBeanWithTerserLanguage extends CamelTestSupport {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        MyRouteBuilderWithBeanAndTerserLanguage routeBuilder = new MyRouteBuilderWithBeanAndTerserLanguage();
